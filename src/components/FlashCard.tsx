...
const FlashCard: React.FC<FlashCardProps> = ({
  ...
  return <div className={cn("flashcard w-full md:w-3/4 lg:w-2/3 max-w-3xl aspect-[4/3] mx-auto cursor-pointer", isFlipped && "flipped")} onClick={() => setIsFlipped(!isFlipped)}>
      <div className="flashcard-inner rounded-xl shadow-lg">
        ...
        <div className="flashcard-back rounded-xl text-white bg-blue-500">
          <h2 className="text-xl md:text-2xl font-bold mb-4">
